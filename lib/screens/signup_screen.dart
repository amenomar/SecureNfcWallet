...
import 'package:login_signup/themes/theme.dart';
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (_formSignupKey.currentState!.validate() &&
                              ...
                              // final key = encrypt.Key.fromUtf8('A1B2C3D4E5F6G7H8I9J0K1L2M3N4O5P6');
                              //final iv1 = IV.fromBase64(encryptedBase64
                                  //.substring(0, 24)); // Extract IV from Base64
                              //final encrypted1 = Encrypted.fromBase64(
                                //  encryptedBase64.substring(24));
